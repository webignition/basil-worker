...
class TestStateFixtureLoader extends AbstractFixtureLoader implements FixtureLoaderInterface
{
    ...
    {
        if ($output) {
            $output->writeln('Importing test states ...');
        }
